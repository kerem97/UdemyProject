...
namespace HotelProject.WebApi.Controllers
{
    ...
    public class DashboardWidgetsController : ControllerBase
    {
        ...
        private readonly IBooking2Service _bookingService;
        private readonly IAppUserService _appUserService;
        private readonly IRoomService _roomService;
        public DashboardWidgetsController(IStaffService staffService, IBooking2Service bookingService, IAppUserService appUserService, IRoomService roomService)
        {
